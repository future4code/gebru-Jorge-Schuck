// A função abaixo recebo por parâmetro
//   o ano atual, o ano de nascimento de uma pessoa, e o
//    ano em que sua carteira de identidade foi emitida (nessa ordem).
//     A função retorna  uma string que indica se a carteira precisa ser renovada ou não.
...
function checaRenovacaoRG(anoAtual: number, anoNascimento: number, anoEmissao: number ) {
   ...
   console.log(checaRenovacaoRG(2022, 1981, 2020))